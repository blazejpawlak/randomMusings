...
def main():
    ...
    if reachabilityTest('8.8.8.8') == True:
        sys.exit(0)
    else:
        ...
        try:
            ...
            if reachabilityTest('192.168.8.1') == False:
                ...
                if reachabilityTest('8.8.8.8') == False:
                    print NOW + ' [error] Still no Internet connection. Aborting.'
                    exit(101)
                else:
                    print NOW + ' [into] Modem is connected to the Internet!'
